...
class TestBuildQuery:
    ...
    def test_and_operator_uses_must(self, gateway):
        dsl = gateway._build_query(["Batch", "Gender"], operator="and")  # noqa SLF001
    ...
    def test_or_operator_uses_should(self, gateway):
        dsl = gateway._build_query(["Batch", "Gender"], operator="or")  # noqa SLF001
    ...
    def test_each_value_queries_both_fields(self, gateway):
        dsl = gateway._build_query(["Batch"], operator="and")  # noqa SLF001
...
class TestExtractStudyIds:
    ...
    def test_extract_from_buckets(self):
        ...
        assert ElasticsearchSampleGateway._extract_study_ids(es_resp) == [  # noqa SLF001
            "MTBLS1",
            "MTBLS2",
        ]
    ...
    def test_extract_missing_aggregations(self):
        assert ElasticsearchSampleGateway._extract_study_ids({}) == []  # noqa SLF001
