...
from mtbls.application.use_cases.indices.public_search_study import schemas
from mtbls.application.use_cases.indices.public_search_study.assay_classifier import (
    AssayClassifier,
    AssayTechnique,
)
...
async def update_study_metadata_json_files(
    ...
    study_map = await get_studies(study_read_repository)
