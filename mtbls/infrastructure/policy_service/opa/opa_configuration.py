...
class OpaConfiguration(BaseConfiguration):
    ...
    validation_url: str = (
        "http://policy-engine:8181/v1/data/metabolights/validation/v2/report/complete_report?pretty=true"
    )
    templates_url: str = "http://policy-engine:8181/v1/data/metabolights/validation/v2/templates"
    control_lists_url: str = "http://policy-engine:8181/v1/data/metabolights/validation/v2/controls"
